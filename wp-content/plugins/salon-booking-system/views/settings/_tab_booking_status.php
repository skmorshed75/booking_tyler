...
?>
<div id="sln-pause_booking_service" class="sln-box sln-box--main">
<h2 class="sln-box-title"><?php _e('Pause booking service <span class="block">If <strong>OFF</strong> the online booking form will be disabled and your users will see a message.</span>', 'salon-booking-system');?></h2>
<div class="row">
